...
public class ContactsTable {
    ...
    public ContactsTable(Context context) {
        ...
        if (!db.isTableExits(TABLENAME)) {
            String createTableSql = "CREATE TABLE IF NOT EXUSTS" + TABLENAME + "(id_DB integer" +
    ...
    public User[] getAllUser() {
        ...
        try {
            ...
            while (cursor.moveToNext()) {
                ...
                temp.setDanwei(cursor.getString(cursor.getColumnIndex(User.MOBILE)));
    ...
    public boolean delectByUser(User user){
